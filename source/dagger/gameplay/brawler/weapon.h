...
namespace brawler {
	...
	public:
		...
		{
			return Weapon(WeaponType::PISTOL, "Pistol", 2, 5, 7, numClips);
		}

		static Weapon MachineGun(int numClips)
		{
			return Weapon(WeaponType::MACHINE_GUN, "Machine Gun", 10, 15, 30, numClips);
		}
		...
		static Weapon CreateRandom() {
			...
			case WeaponType::PISTOL:
				return Pistol(5 + rand() % 20);
			case WeaponType::MACHINE_GUN:
				return MachineGun(3 + rand() % 10);
			default:
