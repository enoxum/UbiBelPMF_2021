...
//             auto distance = glm::length(distanceVec);
...
//                 karen.command.current.x = karen.transform.position.x;
//             }
//             else {
//                 if (distanceVec.y > 0) 
...
//                 karen.command.current.y = karen.transform.position.y;

//             }
            // if(distance < karen.sprite.size.x){
            //     karen.command.curr_action = (next.x - curr.x > 0) ? Action::RIGHT:Action::LEFT;
            //     karen.command.current.x = karen.transform.position.x;
            //     Logger::info("\nIN EPSILON X\n");
            // }
            // else if(EPSILON_NOT_EQUAL(next.y, curr.y)){
            //     karen.command.curr_action = (next.y - curr.y > 0) ? Action::UP:Action::DOWN;
            //     karen.command.current.y = karen.transform.position.y;
            //     Logger::info("\nIN EPSILON Y\n");
            // }
